...
export const blockSchema = z.object({
  ...
  content: z.union([z.string().max(100000), canvasSnapshotSchema, z.null()]),
...
export const updatePageSchema = z.object({
  ...
  content: z.string().max(10 * 1024 * 1024, "Content too large").optional(),
...
export const savePageSchema = z.object({
  ...
  ydocState: z.string().max(10 * 1024 * 1024, "Y.Doc state too large").optional(),
