...
import { createOpenAIClient, getDefaultModel } from './providers/index.js'
...
function getProviderBaseUrl(provider?: AIProvider): string | undefined {
  ...
  switch (provider) {
    case 'groq':
      return AI_CONFIG.groq.baseUrl
    case 'ollama':
      return AI_CONFIG.ollama.baseUrl
    case 'openai':
      return AI_CONFIG.openai.baseUrl
    case 'minimax':
      return AI_CONFIG.minimax.baseUrl
    case 'nvidia':
      return AI_CONFIG.nvidia.baseUrl
    default:
      return undefined
  }
}
